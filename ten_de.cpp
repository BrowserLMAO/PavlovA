#include "ten_de.h"
Ten_de::Ten_de(const std::__cxx11::string p_full_path): Ttranslator(p_full_path, "de_dict.txt", "en_de_dict.txt") {
}

std::string Ten_de::translate(const std::__cxx11::string clause) {
  std::string result;
...
void Ten_de::add_word_to_list(std::__cxx11::string word) {
