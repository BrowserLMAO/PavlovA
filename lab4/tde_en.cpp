...
Tde_en::Tde_en(const std::__cxx11::string p_full_path): Ttranslator(p_full_path, "en_dict.txt", "de_en_dict.txt") {
}

std::string Tde_en::translate(const std::__cxx11::string clause) {
  std::string result;
...
void Tde_en::add_word_to_list(std::__cxx11::string word) {
